...
/*
The js/plugins.js file appears to contain various utility functions and plugins 
that are likely used across your JavaScript project. 
These can include functions for manipulating data, handling events, 
or providing certain functionality like animations or complex UI interactions.

The specific functions you've highlighted seem to be related to timing and function 
execution control, possibly for throttling or debouncing function calls. 
This is often used in scenarios where you want to limit the rate at which a function is executed,
such as scroll or resize event handlers.
*/
